  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center bg-uteropink">
      ...
      <p className="text-pink-700 text-lg max-w-2xl">
        ...
        Our comprehensive fertility solutions are backed by cutting-edge reproductive technologies, expert care, and a commitment to holistic well-being. Whether you're just beginning your fertility journey or seeking specialized treatment, we are here to guide you every step of the way.
